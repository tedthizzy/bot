...
from rover_robotd.profiles import ProgressMonitor, TrapezoidProfile
...
class ActiveCommand:
    ...
    def fraction(self) -> float:
        if self.profile is None:
            return 0.0
        return self.profile.fraction(self.progress)
